...
const Dashboard: React.FC = () => {
    ...
    const fetchData = async () => {
      try {
        const [ventas30DiasResponse, totalCantidadResponse] = await Promise.all([
          axios.get('http://localhost:3001/ventas/total-ultimos-30-dias'),
          axios.get('http://localhost:3001/ventas/total-cantidad')
        ]);
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4 border-b">Informes Generales Ventas al contado</h1>
