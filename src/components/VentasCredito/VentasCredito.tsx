...
const VentasCredito: React.FC = () => {
    ...
    const handleConfirmarVenta = async () => {
        try {
            if (!ventaData.cliente) {
                setTitle('Favor seleccione un cliente');
                setShowModalAdvertencia(true);
                return;
            }
            // Verifica si cantidadCuotas es igual a 0
            if (cantidadCuotas === 0) {
    ...
    return (
        hayCajaAbiertaHoy ? (
            <div className="p-6">
                <h1 className='font-bold text-center border-b'>VENTAS A CREDITO</h1>
                <div className="grid grid-cols-2 justify-center">
                    ...
                    <div className="mb-4 mr-20 ml-20">
                        ...
                        <select
                            ...
                            onChange={e => {
                                ...
                                setVentaData({ ...ventaData, cliente: e.target.value, ruccliente: clienteSeleccionado ? clienteSeleccionado.rucCliente : '' });
                            }}
                        >
                    ...
                    <div className="mb-4 mr-20 ml-20">
                        <label className="block mb-2">Cantidad Cuotas</label>
                        <input
                            type="number"
                ...
                }
                {
                    showModalCuotas && (
                        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75">
                            <div className="bg-white p-6 rounded-lg shadow-lg">
                                <h2>Favor ingrese cantidad de cuotas</h2>
                                <div className='flex justify-center'>
                                    <button
                                        className="mt-4 bg-red-500 text-white p-2 rounded"
