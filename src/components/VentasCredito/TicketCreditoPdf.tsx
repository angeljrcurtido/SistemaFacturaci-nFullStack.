...
const TicketCreditoPDF = ({ venta, cuotainicial, cantidadCuotas }) => {
    // Calcular el estado basado en las cuotas
    const estado = (cuotainicial !== null && cantidadCuotas !== null)
        ? (cuotainicial === cantidadCuotas ? 'Terminado' : 'En Proceso')
        : 'N/A';
    ...
    return (
        <Document>
            <Page size={{ width: 198, height: 'auto' }} style={styles.page}>
                ...
                {cuotainicial !== null && cantidadCuotas !== null && (
                    <View style={styles.section}>
                        <Text style={styles.text}>Cuota Inicial: {cuotainicial}</Text>
                        <Text style={styles.text}>Cantidad de Cuotas: {cantidadCuotas}</Text>
...
export default TicketCreditoPDF;